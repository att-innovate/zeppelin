...
public class AlluxioInterpreter extends Interpreter {
  ...
  protected static final String ALLUXIO_SECURITY_AUTHENTICATION_TYPE =
          "alluxio.security.authentication.type";
  protected static final String ALLUXIO_SECURITY_AUTHORIZATION_PERMISSION_ENABLED =
  ...
  private final String alluxioSecurityAuthenticationType;
  private final String alluxioSecurityAuthorizationPermissionEnabled;
  ...
  public AlluxioInterpreter(Properties property) {
    ...
    alluxioSecurityAuthenticationType =
            property.getProperty(ALLUXIO_SECURITY_AUTHENTICATION_TYPE);
    alluxioSecurityAuthorizationPermissionEnabled =
            property.getProperty(ALLUXIO_SECURITY_AUTHORIZATION_PERMISSION_ENABLED);
  }
  ...
  public void open() {
    ...
    System.setProperty(ALLUXIO_SECURITY_AUTHENTICATION_TYPE,
            alluxioSecurityAuthenticationType);
    System.setProperty(ALLUXIO_SECURITY_AUTHORIZATION_PERMISSION_ENABLED,
            alluxioSecurityAuthorizationPermissionEnabled);
    fs = new AlluxioShell();
